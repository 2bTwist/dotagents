...
2. **Trace Data Flow**
   ...
   - Document API/contract surfaces between components
...
- Read each file involved in the flow (no `limit`/`offset`)
- Note where data is transformed
- Identify external dependencies
- Ultrathink about how all these pieces connect and interact
...
#### 3. State Management (`stores/webhook-store.ts:55-89`)
...
- Feature flags checked at `utils/features.ts:23`
...
- **Read files thoroughly** (no `limit`/`offset`) before making statements
- **Trace actual code paths.** Don't assume.
- **Focus on "how"** not "what" or "why"
- **Be precise** about function names and variables
- **Note exact transformations** with before/after where relevant
