...
- **`/research <question>`** maps how an area of the codebase works today. Invokes `codebase-locator` then `codebase-analyzer` skills in sequence. Writes to `specs/research/YYYY-MM-DD-<slug>.md`. Documents what IS, never what SHOULD BE.
...
Three skills back the research/plan flow. Can be invoked directly too:
